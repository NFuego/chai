...
//        configLog()
        ...
        let slideVC = SlideVC()
        // ====================================== old way configuring windows root view
...
// */
        // ====================================== new way configuring windows root view
        /*
        drawerController.setViewController(SlideVC.aboutVC, side: .none)
        drawerController.setViewController(slideVC, side: .left)
//        drawerController.setViewController(rightViewController, .right)
        slideVC.drawerController?.setTransition(transition: DrawerFoldTransition(), side: .left)
        slideVC.drawerController?.setOverflowTransition(transition: DrawerFoldTransition(), side: .left)
